...
efficientnet_model = tf.keras.applications.efficientnet_v2.EfficientNetV2B0(weights='imagenet', include_top=False, input_shape=(Image_Width,Image_Height,3), include_preprocessing=False )
...
def run_test_harness():
	...
	model.save('EfficientNetV2_B0.h5')
